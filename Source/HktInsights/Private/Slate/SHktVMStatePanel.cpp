...
void SHktVMStatePanel::Tick(const FGeometry& AllottedGeometry, double InCurrentTime, float InDeltaTime)
{
...
void SHktVMStatePanel::RefreshData()
{
    ...
    {
        if (bShowActiveVMs && PassesVMFilter(Entry) && PassesSearchFilter(Entry))
        {
    ...
    if (bShowCompletedVMs)
    {
        ...
        {
            if (PassesVMFilter(Entry) && PassesSearchFilter(Entry))
            {
...
void SHktVMStatePanel::ClearData()
{
    FHktInsightsDataCollector::Get().Clear();
    RefreshData();
}

void SHktVMStatePanel::SetAutoRefresh(bool bEnabled)
{
    bAutoRefresh = bEnabled;
}

TSharedRef<SWidget> SHktVMStatePanel::CreateToolbar()
{
    return SNew(SHorizontalBox)
        ...
        [
            ...
            .OnTextChanged(this, &SHktVMStatePanel::OnSearchTextChanged)
            .OnTextCommitted(this, &SHktVMStatePanel::OnSearchTextCommitted)
        ]
        ...
        [
            ...
            .OnClicked(this, &SHktVMStatePanel::OnPauseResumeButtonClicked)
        ]
        ...
        [
            ...
            .OnClicked(this, &SHktVMStatePanel::OnClearButtonClicked)
        ];
}

TSharedRef<SWidget> SHktVMStatePanel::CreateFilterPanel()
{
    return SNew(SHorizontalBox)
        ...
        [
            SNew(SCheckBox)
            .IsChecked(this, &SHktVMStatePanel::GetFilterCheckState, FString("Pending"))
            .OnCheckStateChanged(this, &SHktVMStatePanel::OnFilterCheckChanged, FString("Pending"))
            [
        ...
        [
            SNew(SCheckBox)
            .IsChecked(this, &SHktVMStatePanel::GetFilterCheckState, FString("Processing"))
            .OnCheckStateChanged(this, &SHktVMStatePanel::OnFilterCheckChanged, FString("Processing"))
            [
        ...
        [
            SNew(SCheckBox)
            .IsChecked(this, &SHktVMStatePanel::GetFilterCheckState, FString("Completed"))
            .OnCheckStateChanged(this, &SHktVMStatePanel::OnFilterCheckChanged, FString("Completed"))
            [
        ...
        [
            SNew(SCheckBox)
            .IsChecked(this, &SHktVMStatePanel::GetFilterCheckState, FString("Failed"))
            .OnCheckStateChanged(this, &SHktVMStatePanel::OnFilterCheckChanged, FString("Failed"))
            [
        ...
        [
            SNew(SCheckBox)
            .IsChecked(this, &SHktVMStatePanel::GetFilterCheckState, FString("ActiveVMs"))
            .OnCheckStateChanged(this, &SHktVMStatePanel::OnFilterCheckChanged, FString("ActiveVMs"))
            [
        ...
        [
            SNew(SCheckBox)
            .IsChecked(this, &SHktVMStatePanel::GetFilterCheckState, FString("CompletedVMs"))
            .OnCheckStateChanged(this, &SHktVMStatePanel::OnFilterCheckChanged, FString("CompletedVMs"))
            [
        ...
        [
            SNew(STextBlock)
            .Text(LOCTEXT("SourceFilterLabel", "Source:"))
        ]
        ...
        [
            ...
            [
                ...
                .HintText(LOCTEXT("SourceFilterHint", "All"))
                .OnTextChanged(this, &SHktVMStatePanel::OnSourceFilterChanged)
            ]
        ]
        ...
        [
            SNew(STextBlock)
            .Text(LOCTEXT("EntityFilterLabel", "Entity:"))
        ]
        ...
        [
            ...
            [
                SNew(SEditableTextBox)
                .HintText(LOCTEXT("EntityFilterHint", "All"))
                .OnTextChanged(this, &SHktVMStatePanel::OnEntityIdFilterChanged)
            ]
        ];
}

TSharedRef<SWidget> SHktVMStatePanel::CreateStatsPanel()
{
    return SNew(SHorizontalBox)
...
void SHktVMStatePanel::OnSearchTextChanged(const FText& NewText)
{
    CurrentSearchText = NewText.ToString();
    RefreshData();
}

void SHktVMStatePanel::OnSearchTextCommitted(const FText& NewText, ETextCommit::Type CommitType)
{
    CurrentSearchText = NewText.ToString();
    RefreshData();
}

FReply SHktVMStatePanel::OnClearButtonClicked()
{
    ClearData();
    return FReply::Handled();
}

FReply SHktVMStatePanel::OnPauseResumeButtonClicked()
{
    bAutoRefresh = !bAutoRefresh;
    return FReply::Handled();
}

void SHktVMStatePanel::OnFilterCheckChanged(ECheckBoxState NewState, FString FilterName)
{
...
ECheckBoxState SHktVMStatePanel::GetFilterCheckState(FString FilterName) const
{
    bool bValue = false;
...
void SHktVMStatePanel::OnSourceFilterChanged(const FText& NewText)
{
    SourceTextFilter = NewText.ToString();
    RefreshData();
}

void SHktVMStatePanel::OnEntityIdFilterChanged(const FText& NewText)
{
    EntityIdTextFilter = NewText.ToString();
    RefreshData();
}

bool SHktVMStatePanel::PassesIntentFilter(const FHktInsightsIntentEntry& Entry) const
{
    switch (Entry.State)
    {
...
bool SHktVMStatePanel::PassesVMFilter(const FHktInsightsVMEntry& Entry) const
{
    // Source 필터
    if (!SourceTextFilter.IsEmpty() && !Entry.Source.Contains(SourceTextFilter, ESearchCase::IgnoreCase))
    {
        return false;
    }

    // Entity ID 필터
    if (!EntityIdTextFilter.IsEmpty())
    {
        FString SubjectStr = FString::Printf(TEXT("%d"), Entry.SubjectId);
        if (!SubjectStr.Contains(EntityIdTextFilter))
        {
            return false;
        }
    }
...
bool SHktVMStatePanel::PassesSearchFilter(const FHktInsightsIntentEntry& Entry) const
{
...
bool SHktVMStatePanel::PassesSearchFilter(const FHktInsightsVMEntry& Entry) const
{
    if (CurrentSearchText.IsEmpty())
    {
        return true;
    ...
    // Source에서 검색
    if (Entry.Source.Contains(CurrentSearchText, ESearchCase::IgnoreCase))
    {
        return true;
    }
