...
FHktEntityId FHktWorldState::AllocateEntity()
{
    ...
    HKT_EVENT_LOG_ENTITY(HktLogTags::Core_Entity, EHktLogLevel::Info, EHktLogSource::Server,
...
void FHktWorldState::AddTag(FHktEntityId Entity, const FGameplayTag& Tag)
{
    ...
    HKT_EVENT_LOG_TAG(HktLogTags::Core_Entity, EHktLogLevel::Info, EHktLogSource::Server,
