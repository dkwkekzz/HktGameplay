...
private:
    ...
    // ===== Animation & VFX =====
    void Op_PlayAnim(FHktVMRuntime& Runtime, int32 LayerIndex, RegisterIndex Entity, int32 TagNetIndex);
    void Op_PlayAnimMontage(FHktVMRuntime& Runtime, RegisterIndex Entity, int32 TagNetIndex);
    void Op_StopAnim(FHktVMRuntime& Runtime, int32 LayerIndex, RegisterIndex Entity);
